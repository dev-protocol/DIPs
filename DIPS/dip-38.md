...
| `RewardPrices`                            | Change | Add "cap by geometric mean" to the values.                                                                                                                                                                                                                                                                                       |
| `calculateCumulativeRewardPrices`         | Change | Add "cap by geometric mean" to the return value. The "cap by geometric mean" is calculated by the following formula: `geometricMeanLockedUp * (holders price)`                                                                                                                                                                   |
| `_calculateCumulativeHoldersRewardAmount` | Change | The number of stakings( value of `getStoragePropertyValue(PROPERTY)` ) uses in the calculation deducts the "disabled lockedups."                                                                                                                                                                                                 |
| `calculateRewardAmount`                   | New    | Returns the return value for `_calculateCumulativeHoldersRewardAmount` and "cap by geometric mean".                                                                                                                                                                                                                              |
...
| Method/Struct      | Type   | Spec                                                                                                                                                                                                                                                                                                   |
| ------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `_calculateAmount` | Change | If the original withdrawable amount exceeds the "withdrawal limit," the "withdrawal limit" will be returned. The "withdrawal limit" is calculated by dividing the value of `Lockup.calculateRewardAmount` by the value of `Property.totalSupply` and multiplying by the balance of the passed account. |
